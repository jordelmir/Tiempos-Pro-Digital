      ...
      <div className="relative max-w-md w-full mx-4 my-8 flex flex-col min-h-[auto]">
        ...
        <div className="bg-[#0a0a0f] border border-cyber-purple/40 rounded-2xl overflow-hidden shadow-[0_0_80px_rgba(188,19,254,0.2)] relative z-10 group flex flex-col w-full">
          <div className="bg-[#1a1a24]/95 backdrop-blur-xl p-6 border-b border-cyber-purple/20 flex justify-between items-start relative overflow-hidden sticky top-0 z-50 shrink-0">
            ...
            <button
              onClick={onClose}
              className="text-slate-500 hover:text-white transition-colors z-10 bg-black/20 rounded-full w-8 h-8 flex items-center justify-center hover:bg-cyber-purple/20"
            >
          ...
          <div className="p-6 space-y-6 bg-gradient-to-b from-[#0a0a0f] to-[#050508] flex-1">
            ...
            {!success ? (
              <div className="space-y-5 animate-in slide-in-from-bottom-2">
                <div>
                  <label className="block text-[10px] font-mono font-bold text-slate-400 uppercase mb-2 tracking-wider">
                    Concepto
                  </label>
                  <div className="grid grid-cols-2 gap-2">
                    {[
                      ...
                      <button
                        ...
                        className={`py-2.5 px-3 rounded-lg text-[9px] font-bold uppercase border transition-all duration-300 ${concept === opt.id ? 'bg-cyber-purple/20 border-cyber-purple text-cyber-purple shadow-[0_0_15px_rgba(188,19,254,0.2)]' : 'bg-black/40 border-slate-800 text-slate-500 hover:border-slate-600 hover:text-white'}`}
                      >
                        {opt.label}
                      </button>
                    ))}
                ...
                <div>
                  ...
                  <div className="relative group/input">
                    <input
                      ...
                      autoFocus
                    />
                    <div className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-500 font-bold text-xs z-20">
                      CRC
                    </div>
                  </div>
                </div>
              ...
              <div className="text-center py-8 animate-in zoom-in duration-300 relative">
                <h4 className="text-3xl font-display font-black text-white uppercase mb-2 tracking-wide text-shadow-purple">
                  Pago Exitoso
                </h4>
                <div className="bg-black/50 border border-cyber-purple/30 rounded px-4 py-2 inline-block mb-8">
                  ...
                  <div className="font-mono text-cyber-purple text-lg font-bold tracking-widest">
                    {txId}
                  </div>
                </div>
              </div>
