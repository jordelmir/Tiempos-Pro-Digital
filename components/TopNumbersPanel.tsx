...
export default function TopNumbersPanel() {
    ...
    // Lógica para calcular números top basados en DATOS REALES
    const topStats = useMemo(() => {
        const counts: Record<string, number> = {};
        
        // 1. Peso: Ganadores Recientes - Peso Fuerte
        history.forEach(h => {
        ...
        // 2. Peso: Apuestas Populares (Volumen) - Peso Moderado
    ...
    return (
        <div className="relative w-full group animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="relative bg-[#050a14] border-y-2 border-x border-t-cyber-neon/30 border-b-cyber-purple/30 border-x-transparent rounded-[2rem] p-6 shadow-2xl overflow-hidden backdrop-blur-xl">
                ...
                <div className="flex flex-col md:flex-row items-center justify-between mb-4 px-2 relative z-10 gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-[9px] font-mono text-slate-500 uppercase tracking-[0.3em] mt-1">
                                Top 10 Frecuencia Global (Volumen + Historial)
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10">
                        ...
                        <span className="text-[9px] font-bold text-cyber-success uppercase tracking-wider">Análisis en Vivo</span>
                    </div>
                </div>
