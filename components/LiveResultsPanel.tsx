...
export default function LiveResultsPanel() {
    ...
    return (
        <div className="relative w-full group max-w-[1600px] mx-auto">
            ...
            {/* MAIN COMMAND HUD - GLASS MORPHISM APPLIED */}
            <div className="relative w-full">
                <div className="absolute -inset-4 bg-cyber-neon/20 rounded-[4rem] blur-3xl animate-pulse transition-all duration-1000 opacity-20"></div>
                <div className="relative w-full glass-morphism bg-black/40 border-2 border-white/10 rounded-[3rem] md:rounded-[4rem] p-6 md:p-12 lg:p-16 overflow-hidden z-10 shadow-[0_0_100px_rgba(0,0,0,0.8)] transition-all duration-700 hover:border-cyber-neon/30">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-center mb-12 lg:mb-20 relative z-10 gap-10">
                        <div className="flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
                            <div className="relative">
                                ...
                                <div className="w-24 h-24 md:w-28 md:h-28 rounded-3xl bg-black/60 border-2 border-cyber-neon/50 flex items-center justify-center shadow-neon-cyan relative z-10 transition-transform duration-700 hover:rotate-6 backdrop-blur-sm">
                            ...
                            <div>
                                <h2 className="text-5xl md:text-6xl font-display font-black text-white uppercase tracking-tighter flex flex-col leading-none">
                                    <span className="text-[9px] font-mono text-slate-500 tracking-[0.4em] mb-2 font-bold uppercase">CORE_SERVER_v5.5</span>
                                ...
                                <div className="flex flex-wrap justify-center md:justify-start items-center gap-4 mt-6">
                                    ...
                                    <span className="text-[9px] font-mono text-slate-500 uppercase tracking-[0.4em] font-bold">Protocolo Phront Maestro</span>
                                </div>
                            </div>
                        </div>

                        <div className="hidden xl:flex items-center gap-12 glass-morphism bg-black/50 p-8 rounded-[2.5rem] border border-white/5 backdrop-blur-xl shadow-inner">
                            <div className="text-right">
                                <div className="text-[9px] text-slate-500 uppercase font-black tracking-widest mb-2">LATENCIA_RED</div>
                            ...
                            <div className="text-right">
                                <div className="text-[9px] text-slate-500 uppercase font-black tracking-widest mb-2">NÚCLEOS_SINC</div>
