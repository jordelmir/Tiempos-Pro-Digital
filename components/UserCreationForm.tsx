            ...
            <form onSubmit={submit} className="p-6 md:p-10 space-y-10 flex-1">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className={`p-5 rounded-2xl bg-black/50 border border-${activeTheme.name}-500/20 shadow-inner group-hover:border-${activeTheme.name}-500/40 transition-all duration-700`}>
