                        ...
                        <div className="flex gap-2 overflow-x-auto pb-1 no-scrollbar">
                            {[
                                ...
                                <button
                                    ...
                                    className={`px-5 py-2.5 rounded-lg text-[10px] font-bold uppercase border-2 transition-all whitespace-nowrap hover:-translate-y-0.5 ${filterSeverity === filter.id ? filter.active : `${filter.color} hover:border-white/50 hover:text-white bg-black`
                                        }`}
                                >
                                    {filter.label}
                                </button>
                    ...
                    {loading && logs.length === 0 ? (
                        ...
                        filteredLogs.map((log) => (
                            <div key={log.id} className="relative pl-12 md:pl-24 group perspective-1000">
                                ...
                                <div className={`absolute left-[10px] md:left-[26px] top-8 w-4 h-4 rounded-full border-2 bg-black z-20 transition-all duration-300 ${log.severity === AuditSeverity.CRITICAL ? 'border-red-500 shadow-[0_0_20px_red] animate-pulse bg-red-900' :
