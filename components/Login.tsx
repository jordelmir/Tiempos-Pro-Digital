                                ...
                                <div className="mt-8 pt-6 border-t border-white/5">
                                    ...
                                    <div className="grid grid-cols-3 gap-3">
                                        <button
                                            ...
                                            className={`py-3 rounded-lg border transition-all duration-300 flex flex-col items-center justify-center gap-2 group relative overflow-hidden ${activeRole === 'ADMIN'
                                        ...
                                        >
                                            <i className={`fas fa-shield-alt text-lg ${activeRole === 'ADMIN' ? 'text-rose-500' : 'opacity-50'}`}></i>
                                        ...
                                        <button
                                            ...
                                            className={`py-3 rounded-lg border transition-all duration-300 flex flex-col items-center justify-center gap-2 group relative overflow-hidden ${activeRole === 'VENDOR'
                                        ...
                                        >
                                            <i className={`fas fa-store text-lg ${activeRole === 'VENDOR' ? 'text-violet-500' : 'opacity-50'}`}></i>
                                            <span className="text-[8px] font-black uppercase tracking-widest">Vendedor</span>
                                        </button>

                                        <button
                                            type="button"
                                            onClick={() => setActiveRole('PLAYER')}
                                            className={`py-3 rounded-lg border transition-all duration-300 flex flex-col items-center justify-center gap-2 group relative overflow-hidden ${activeRole === 'PLAYER'
                                        ...
                                        >
                                            <i className={`fas fa-gamepad text-lg ${activeRole === 'PLAYER' ? 'text-cyan-400' : 'opacity-50'}`}></i>
                                            <span className="text-[8px] font-black uppercase tracking-widest">Jugador</span>
                                        </button>
                                    </div>
                                </div>
